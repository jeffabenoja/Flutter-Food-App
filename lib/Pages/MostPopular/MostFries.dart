...
class MostFries extends StatefulWidget {
  const MostFries({Key? key}) : super(key: key);

  @override
  _MostFriesState createState() => _MostFriesState();
}

class _MostFriesState extends State<MostFries> {
  int quantityItem1;
