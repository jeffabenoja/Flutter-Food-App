...
class FirstNewItem extends StatefulWidget {
  const FirstNewItem({Key? key}) : super(key: key);

  @override
  _FirstNewItemState createState() => _FirstNewItemState();
}

class _FirstNewItemState extends State<FirstNewItem> {
  int quantityItem1;
  int initialPriceItem1;

  _FirstNewItemState()
      : quantityItem1 = 1,
        initialPriceItem1 = 280;
