...
class FourthNewItem extends StatefulWidget {
  const FourthNewItem({Key? key}) : super(key: key);

  @override
  _FourthNewItemState createState() => _FourthNewItemState();
}

class _FourthNewItemState extends State<FourthNewItem> {
  int quantityItem1;
