...
class SixthNewItem extends StatefulWidget {
  const SixthNewItem({Key? key}) : super(key: key);

  @override
  _SixthNewItemState createState() => _SixthNewItemState();
}

class _SixthNewItemState extends State<SixthNewItem> {
  int quantityItem1;
