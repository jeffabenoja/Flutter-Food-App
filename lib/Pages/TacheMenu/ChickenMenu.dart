      ...
      body: ListView(
        children: [
          ...
          _buildChickenItem(
              0,
              "Honey Lemon",
              "Tender chicken glazed with a sweet and tangy honey lemon infusion.",
              "220.00"),
          _buildChickenItem(
              1,
              "Soy Garlic",
              "Succulent chicken coated in a savory blend of soy and aromatic garlic.",
              "270.00"),
          _buildChickenItem(
              2,
              "Cheesy Delight",
              "Irresistible chicken with a gooey layer of melted cheese perfection.",
              "190.00"),
          _buildChickenItem(
              3,
              "Crispy Classic",
              "Classic appeal with golden, crispy skin enveloping juicy and flavorful chicken.",
              "240.00"),
          _buildChickenItem(
              4,
              "Yangnyeo Spice",
              "Spicy kick infused with Korean yangnyeom, delivering bold flavor to every bite.",
              "245.00"),
        ],
      ),
      drawer: DrawerWidget(),
