      ...
      body: ListView(
        children: [
          ...
          _buildFriesItem(
              0,
              "Overloaded Fries",
              "A mountain of toppings—cheese, bacon, and more—on golden, crispy fries.",
              "160.00"),
          _buildFriesItem(
              1,
              "Nacho Fries",
              "Crispy fries topped with melted cheese, jalapeños, and zesty nacho goodness.",
              "180.00"),
          _buildFriesItem(
              2,
              "Cheesy Bacon",
              "Irresistible fries smothered in gooey cheese and topped with crispy bacon bits.",
              "230.00"),
          _buildFriesItem(
              3,
              "Sour Cream",
              "Crispy fries paired with tangy sour cream for a simple, satisfying treat.",
              "150.00"),
          _buildFriesItem(
              4,
              "Cheesy Fries",
              "Classic golden fries adorned with a generous serving of melted cheese.",
              "145.00"),
        ],
      ),
      drawer: DrawerWidget(),
